...
import { 
  Search, Save, Upload, Download, Printer, Eye, Edit, User, Calendar, AlertCircle,
  CheckCircle, Plus, X, Trash2, Filter, ChevronLeft, ChevronRight, Mail, Phone, MapPin,
  Users, Award, Clock, FileCheck, BarChart3, List, Loader2,
  UserCircle, FileText, Home, Globe, CreditCard, BookOpen, CheckSquare,
  FileBox, Image as ImageIcon, File, Briefcase, GraduationCap, CalendarDays,
  FileSpreadsheet, FileImage, FileArchive, FileCode, Paperclip, FolderOpen,
  EyeOff, Eye as EyeOpen, ExternalLink, Copy, Check, FolderPlus,
  ...
  const handleModalSubmit = async () => {
    ...
    try {
      ...
      const newStudent = {
        ...
        grade1: newStudentData.grade1 || '',
        grade2: newStudentData.grade2 || '',
        grade3: newStudentData.grade3 || '',
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  className={`w-full px-3 py-2.5 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm ${
                    modalErrors.trade ? 'border-red-500' : 'border-gray-300'
                  }`}
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  className="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm"
                  value={newStudentData.grade1}
                  onChange={(e) => handleModalChange('grade1', e.target.value)}
                >
              ...
              <div>
                ...
                <select
                  className="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm"
                  value={newStudentData.grade2}
                  onChange={(e) => handleModalChange('grade2', e.target.value)}
                >
                  <option value="">Select Grade</option>
                  <option value="A">A</option>
                  <option value="A-">A-</option>
              ...
              <div>
                ...
                <select
                  className="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm"
                  value={newStudentData.grade3}
                  onChange={(e) => handleModalChange('grade3', e.target.value)}
                >
                  <option value="">Select Grade</option>
                  <option value="A">A</option>
                  <option value="A-">A-</option>
        ...
        <div className="bg-white rounded-xl shadow-lg w-full max-w-6xl max-h-[90vh] overflow-hidden flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-3 sm:p-4 md:p-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
              ...
              {/* Right Column - Exam & Payment Details */}
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="bg-white border rounded-xl shadow-sm p-4 sm:p-5">
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    ...
                    <div>
                      <label className="text-xs sm:text-sm font-medium text-gray-500">SLCCL Result</label>
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      <div>
                        <label className="text-xs sm:text-sm font-medium text-gray-500">Grade 1</label>
                        <p className="text-gray-900 mt-1 text-sm sm:text-base">{selectedStudent.grade1 || 'N/A'}</p>
                      </div>
                      <div>
                        <label className="text-xs sm:text-sm font-medium text-gray-500">Grade 2</label>
                        <p className="text-gray-900 mt-1 text-sm sm:text-base">{selectedStudent.grade2 || 'N/A'}</p>
                      </div>
                      <div>
                        <label className="text-xs sm:text-sm font-medium text-gray-500">Grade 3</label>
                        <p className="text-gray-900 mt-1 text-sm sm:text-base">{selectedStudent.grade3 || 'N/A'}</p>
                      </div>
                    </div>
                    <div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between space-y-3 sm:space-y-0">
              ...
              <div className="flex items-center space-x-1 sm:space-x-2">
                <button
                  ...
                  className={`px-2 sm:px-3 py-1.5 sm:py-2 border rounded-lg flex items-center transition-colors text-xs sm:text-sm ${
                    currentPage === 1 
