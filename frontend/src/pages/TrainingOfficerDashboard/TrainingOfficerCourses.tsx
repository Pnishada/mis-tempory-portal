...
import { type CourseType, fetchCourses, createCourse, updateCourse, deleteCourse, fetchInstructors, fetchUsers, fetchCourseCategories, fetchCourseDurations, fetchAvailableCourseCodes, type CourseCodeType } from '../../api/api';
