...
import { fetchGeneralApprovals, updateApprovalStatus } from '../../../api/cbt_api'; // Adjust path if needed
import type { ApprovalType } from '../../../api/cbt_api'; // Adjust path if needed
...
const Approvals: React.FC = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      label: 'Priority',
      render: (value: string) => (
        <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${value === 'High' ? 'bg-red-100 text-red-800' :
    ...
    },
    {
      ...
      render: (value: string) => (
        <div className="flex items-center">
          ...
          <span className={`text-xs font-semibold ${value === 'Pending' ? 'text-yellow-800' :
