...
import { Users, GraduationCap, BookOpen, TrendingUp, Building2, Target, FileText, CheckCircle, AlertCircle, Clock } from 'lucide-react';
import { LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, PieChart, Pie, Cell } from 'recharts';
import { fetchOverview, fetchDashboardStats, type OverviewDataType, type DashboardStatsType } from '../../../api/cbt_api';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Bottom Section - 1 Column Layout (Recent Activities only) */}
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between mt-1">
                        <span className={`text-xs px-2 py-1 rounded-full ${activity.type === 'success' ? 'bg-green-50 text-green-700' :
